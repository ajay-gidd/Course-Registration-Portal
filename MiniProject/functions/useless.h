#ifndef USELESS_FUNCTIONS
#define USELESS_FUNCTIONS
...
bool login_handler1(bool isAdmin, int connFD, struct Student *ptrToStudent)
{
    ...
    else
    {
        ...
        int customerFileFD = open("Record_file/Student_file", O_RDONLY);
        if (customerFileFD == -1)
        {
